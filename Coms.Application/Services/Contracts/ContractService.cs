    ...
    public class ContractService : IContractService
    {
                ...
                string name, string creatorName, int? status, int currentPage, int pageSize)
        {
            ...
            //    var predicate = PredicateBuilder.New<Access>(true);
                ...
                //    else
                //    {
                //        var contractAccesses = await _accessRepository.GetAccessByContractId(contract.Contract.Id);
                //        var authorAccess = contractAccesses
                //                .Where(aa => aa.AccessRole.Equals(AccessRole.Author)).FirstOrDefault();
                //        var author = await _userAccessRepository.GetByAccessId(authorAccess.Id);
                //        contractResult.CreatorId = author.User.Id;
                //        contractResult.CreatorName = author.User.FullName;
                //        contractResult.CreatorEmail = author.User.Email;
                //        contractResult.CreatorImage = author.User.Image;
                //    }
